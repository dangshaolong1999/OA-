<template>
	<el-dialog title="审批详情" :visible.sync="detailsVisible">
		<el-form>
			<el-form-item label="审批流程" :label-width="formLabelWidth">
		...
		<div slot="footer" class="dialog-footer">
			<el-button type="primary" @click="detailsVisible = false">通过</el-button>
			<el-button @click="detailsVisible = false">驳回</el-button>
		</div>
	</el-dialog>
</template>
