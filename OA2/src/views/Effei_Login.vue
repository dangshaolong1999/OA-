			...
			<div class="footer-box">
				<el-form :model="loginForm" :rules="rules" ref="loginForm">
					...
					<div class="forget-box">
						<el-button @click="editFlag">忘记密码？</el-button>
					</div>
...
<script>
import EffeiEdit from '../components/Effei_edit.vue'
export default {
	components: { EffeiEdit },
	data() {
		return {
			loginForm: {
				username: '',
	...
	methods: {
		...
		editFlag() {
			this.$store.commit('edit/editFlag', this.dialogFormVisible)
		}
	}
}
</script>
